        ...
        <div className="p-1 rounded-lg bg-gradient-to-br from-blue-500 to-green-500">
          <form onSubmit={onSubmitForm} className="flex flex-col px-8 py-6 gap-y-4 bg-gray-900 rounded-lg">
            <h1 className="mx-auto flex flex-col text-center">
              ...
              <span className="bg-clip-text text-transparent text-2xl font-bold bg-gradient-to-r from-blue-400 to-indigo-400 text-center uppercase">
                Blablaland.fun
              </span>
            </h1>
            {error && (
            ...
            <div className="flex flex-col gap-y-2">
              ...
              {is2FaEnabled && (
                <div className="flex flex-row items-center gap-x-6">
                  <label className="text-white text-base w-28" title="Code indiqué sur votre application d'authentification à deux facteurs">
                    Code 2FA :
                  </label>
              ...
              <div className="px-3 py-2 inline-flex w-full justify-center uppercase font-bold text-white text-sm rounded-full relative bg-gray-900 group-hover:bg-gray-900 group-hover:bg-opacity-95">
                ...
                {isLoading && (
                  <svg
                    ...
                    className="h-5 w-5 ml-2 absolute animate-pulse right-3"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
